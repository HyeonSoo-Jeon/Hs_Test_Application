...
public class Prob6Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Lv6_O).setOnClickListener(this);
        findViewById(R.id.Lv6_X).setOnClickListener(this);
        findViewById(R.id.LV6_back).setOnClickListener(this);

        //여기
        btnO = findViewById(R.id.Lv6_O);
        btnX = findViewById(R.id.Lv6_X);
        if(Answers.get(2)==1){
