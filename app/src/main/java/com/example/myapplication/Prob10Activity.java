...
public class Prob10Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Lv10_1).setOnClickListener(this);
        findViewById(R.id.Lv10_2).setOnClickListener(this);
        findViewById(R.id.Lv10_3).setOnClickListener(this);
        findViewById(R.id.Lv10_4).setOnClickListener(this);
        findViewById(R.id.LV10_back).setOnClickListener(this);

        //여기
        btn1 = findViewById(R.id.Lv10_1);
        btn2 = findViewById(R.id.Lv10_2);
        btn3 = findViewById(R.id.Lv10_3);
        btn4 = findViewById(R.id.Lv10_4);
