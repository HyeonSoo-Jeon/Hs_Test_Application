...
public class Prob18Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Lv18_O).setOnClickListener(this);
        findViewById(R.id.Lv18_X).setOnClickListener(this);
        findViewById(R.id.LV18_back).setOnClickListener(this);

        //여기
        btnO = findViewById(R.id.Lv18_O);
        btnX = findViewById(R.id.Lv18_X);
        if(Answers.get(2)==1){
