...
public class Prob7Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Lv7_O).setOnClickListener(this);
        findViewById(R.id.Lv7_X).setOnClickListener(this);
        findViewById(R.id.LV7_back).setOnClickListener(this);

        //여기
        btnO = findViewById(R.id.Lv7_O);
        btnX = findViewById(R.id.Lv7_X);
        if(Answers.get(2)==1){
