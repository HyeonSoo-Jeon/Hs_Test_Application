...
public class Prob19Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Lv19_O).setOnClickListener(this);
        findViewById(R.id.Lv19_X).setOnClickListener(this);
        findViewById(R.id.LV19_back).setOnClickListener(this);

        //여기
        btnO = findViewById(R.id.Lv19_O);
        btnX = findViewById(R.id.Lv19_X);
        if(Answers.get(2)==1){
