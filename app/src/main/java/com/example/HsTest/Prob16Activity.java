...
// 여기
public class Prob16Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 여기
        setContentView(R.layout.activity_prob16);
        ...
        switch (view.getId()){
            ...
            case R.id.ToLv17:
                ...
                if (answer == 0) {
                    ...
                    Intent intent = new Intent(this, Prob17Activity.class);
            ...
            case R.id.LV16_back:
                // 여기
                Intent intent2 = new Intent(this, Prob15Activity.class);
